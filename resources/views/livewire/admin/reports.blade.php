<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a
            ...
            href="{{ route('admin.reports.print', [
                'type' => $this->type,
                'from' => $this->from,
                'to' => $this->to,
                'status' => $this->status,
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <div class="flex items-end gap-2">
            <flux:button icon="arrow-path" wire:click="resetFilters" variant="primary" color="blue">
                Reset
            </flux:button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
        <div class="flex flex-col gap-1" x-show="$wire.type === 'appointments'">
            ...
            <flux:select wire:model.live="status" class="rounded border border-gray-300 px-3 py-2">
        ...
        <div class="flex flex-col gap-1" x-show="$wire.type === 'appointments'">
            ...
            <flux:select wire:model.live="service_category" class="rounded border border-gray-300 px-3 py-2">
                <flux:select.option value="">All</flux:select.option>
